...
- **Listing prep (internal):** maintainer copy in repo root `marketplace.md`—not linked from customer-facing site navigation; bookmark or open from the repository if you need the field checklist.  
