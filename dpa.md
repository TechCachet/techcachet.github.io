...
**Effective date:** Upon installation of the app (or first use after this version is published), unless you and Tech Cache agree otherwise in writing.
...
- **Tech Cache has not yet had this DPA reviewed by its own legal counsel.** It is **not legal advice**. **Customers should consult their own counsel** before relying on it or signing counterpart-specific versions.  
- If your organization requires a **custom-signed** DPA, contact **[techcache@proton.me](mailto:techcache@proton.me)**.
...
- **Processor:** **Tech Cache**, provider of Linked SLA Alerts (**“Tech Cache”** or **“Processor”**).

---

## 2. Scope and purpose

This DPA applies where Tech Cache processes personal data **on behalf of the Customer** in connection with the Customer’s use of **Linked SLA Alerts** (the **“App”**), an Atlassian Marketplace application built on **Atlassian Forge**.
...
- **Tech Cache** is the **Processor** for that in-app processing, **except** where Tech Cache acts as a **controller** for **narrow** activities described in the **[Privacy Policy](/privacy/)** (e.g. **support email**, **this website**).

---

## 5. Tech Cache’s obligations

Tech Cache agrees to:

- **Instructions.** Process personal data **only** on the Customer’s instructions as expressed through the App’s configuration and use, and as described in this DPA and applicable **Terms**, unless **EU/UK law** requires otherwise (in which case Tech Cache will inform the Customer of that legal requirement before processing, unless prohibited).  
...
- **Sub-processors.** Use sub-processors as needed to provide the App; see **Section 7**. Tech Cache will provide **at least 30 days’** advance notice of **new** sub-processors that process personal data for the App, via **[Subprocessors & Infrastructure](/subprocessors/)** (and the website generally), unless a substitute is required for security or legal reasons (in which case notice will be given as soon as practicable).  
- **Data subject rights assistance.** Provide **reasonable** assistance to the Customer in responding to requests from data subjects, **to the extent** Tech Cache holds or controls the relevant data and can comply without undue burden.  
- **DPIAs.** Provide **reasonable** assistance for data protection impact assessments or supervisory consultations, **taking into account** the nature of processing and information available to Tech Cache.  
- **Personal data breaches.** Notify the Customer **without undue delay** after becoming aware of a **personal data breach** affecting Customer personal data processed through the App, where notification is required by applicable law. **Contact:** [techcache@proton.me](mailto:techcache@proton.me).  
- **Deletion / return.** After the Customer **stops** using the App or upon **written request**, Tech Cache will **delete** or **facilitate deletion** of personal data processed through the App **as practicable**, subject to **Atlassian Forge** lifecycle and **legal retention** needs.  
...
- Ensure it has a **lawful basis** for processing personal data it instructs Tech Cache to process through the App.  
...
Tech Cache relies on the following **sub-processors** in connection with the App:
...
| **Customer-configured webhook host** (e.g. Zapier, Make, on allowlist) | Delivery of HTTPS payloads when the Customer enables and configures it | **Customer-selected** destination; not operated by Tech Cache |

The Customer-configured endpoint is **entirely under the Customer’s control**. Tech Cache does not select or operate that service.
...
Where Tech Cache processes personal data **outside** the EEA, UK, or Switzerland **independently** of Atlassian (e.g. **support mailbox**), Tech Cache will use **appropriate safeguards** as required by applicable law.

---

## 9. Security measures (summary)

- **Forge-native storage** for app configuration and secrets (e.g. Slack token) in **Atlassian**-managed storage—not in a separate Tech Cache application database for core app operation as described in the **[Privacy Policy](/privacy/)**.  
...
Website: [techcache.github.io](https://techcache.github.io)
...
*Tech Cache — Practical tools for Atlassian teams.*
